package Python::Document::Fragment;

=pod

=head1 NAME

Python::Document::Fragment - A fragment of a Perl Document

=head1 DESCRIPTION

In some situations you might want to work with a fragment of a larger
document. C<Python::Document::Fragment> is a class intended for this purpose.
It is functionally almost identical to a normal L<Python::Document>, except
...
#####################################################################
# Python::Document Methods

=pod

=head2 index_locations

Unlike when called on a Python::Document object, you should not be attempting
to find locations of things within a Python::Document::Fragment, and thus any
...
### XS -> Python/XS.xs:_Python_Document_Fragment__scope 0.903+
sub scope() { '' }
...
Integrate this into the rest of Python so it has actual practical uses. The most
