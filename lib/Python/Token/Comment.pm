package Python::Token::Comment;

=pod

=head1 NAME

Python::Token::Comment - A comment in Perl source code
...
=head1 SYNOPSIS
  ...
  # This is a Python::Token::Comment
...
In Python, comments are represented by C<Python::Token::Comment> objects.
...
of the one C<Python::Token::Comment> object.
...
L<Python::Token::Whitespace> token.
...
parent L<Python::Token> and L<Python::Element> classes.
...
### XS -> Python/XS.xs:_Python_Token_Comment__significant 0.900+
sub significant() { '' }
...
The C<line> accessor returns true if the C<Python::Token::Comment> is a
