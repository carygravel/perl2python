package Python::Token::BOM;

=pod

=head1 NAME

Python::Token::BOM - Tokens representing Unicode byte order marks
...
be treated as L<Python::Token::Whitespace>.  We recognize the byte order
...
Note that as of this writing, Python only has support for UTF-8
...
L<Python::Token> and L<Python::Element> classes.
...
sub __TOKENIZER__on_line_start {
	...
	$t->{class} = 'Python::Token::Whitespace';
